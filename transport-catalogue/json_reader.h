...
public:
    ...
    void ApplyCommands(transport_catalogue::TransportCatalogue& transport_catalogue, MapRenderer& map_renderer, TransportRouter& router) const;
...
private:
    ...
    const json::Dict* routing_settings_commands_;
    ...
    void ProcessRouteSettingCommands(TransportRouter& router) const;
};